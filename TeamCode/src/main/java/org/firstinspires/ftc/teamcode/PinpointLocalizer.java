...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -47.31978894467331; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1045.437018916489; // x position of the perpendicular encoder (in tick units)
    }
